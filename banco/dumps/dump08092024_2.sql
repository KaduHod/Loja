...
COPY public.product (id, name, business_id, description, file_prefix, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: product product_business_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT product_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id);
