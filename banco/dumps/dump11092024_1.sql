...
1	business	2024-09-11 06:08:16.788725	2024-09-11 06:08:16.788725
2	product	2024-09-11 06:08:16.788725	2024-09-11 06:08:16.788725
3	store	2024-09-11 06:08:16.788725	2024-09-11 06:08:16.788725
4	person	2024-09-11 06:08:16.788725	2024-09-11 06:08:16.788725
\.
...
COPY public.file_category (file_id, category_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.files (id, file_name, category, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: category category_name_key; Type: CONSTRAINT; Schema: public; Owner: root
--
...
ALTER TABLE ONLY public.file_category
    ADD CONSTRAINT file_category_pkey PRIMARY KEY (file_id, category_id);
...
--
-- Name: file_category file_category_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.file_category
    ADD CONSTRAINT file_category_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.category(id);


--
-- Name: file_category file_category_file_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--

ALTER TABLE ONLY public.file_category
    ADD CONSTRAINT file_category_file_id_fkey FOREIGN KEY (file_id) REFERENCES public.files(id);
